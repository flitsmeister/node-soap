...
Client.prototype._initializeOptions = function(options) {
  this.streamAllowed = true; // it's Gzip so always stream!;
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  if (this.streamAllowed && typeof self.httpClient.requestStream === 'function') {
    ...
    req = self.httpClient.requestStream(location, zlib.gzipSync(xml), headers, options, self);
  ...
  req = self.httpClient.request(location, zlib.gzipSync(xml), function(err, response, body) {
    self.lastResponse = body;
    self.lastResponseHeaders = response && response.headers;
